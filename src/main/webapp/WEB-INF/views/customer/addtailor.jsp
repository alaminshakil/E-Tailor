                ...
                <jsp:include page="/WEB-INF/views/partial/topnav.jsp"></jsp:include>
                    ...
                    <div class="page-inner">
                        <div class="page-title">
                            <h class="listtittle">Showing for :: ${sessionScope.zoneSelected.zonename} :: ${sessionScope.areaSelected.areaname}  </h>
                        </div>
                        <div id="main-wrapper">
                            <div class="row">
                                <!--main content start-->
...
<!--                                                            <td>{{tailor.areaid}}</td>
                                                            ...
                                                            <td>{{tailor.phone}}</td>
                                                            <td><a href="selectTailorBtn?getTailorId={{tailor.tailorid}}"><button id="editbuttons" type="submit" class="btn btn-primary">Select</button></a> 
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>  
                                ...
                                <div class="col-md-8" style="margin-left: 150px">
                                    <div class="panel panel-white">
                                        <div class="panel-heading clearfix">
                                            <a  class="btn btn-info btn-lg"style="margin-left: 250px">
                                                <span class="glyphicon glyphicon-shopping-cart"></span> Shopping Cart
                                            </a>    <br> <br>                                            
                                             Your Zone:  ${sessionScope.zoneSelected.zonename} <br> <br>
                                             Your Area:  ${sessionScope.areaSelected.areaname}
                                    </div>
                                </div>
                            </div>
