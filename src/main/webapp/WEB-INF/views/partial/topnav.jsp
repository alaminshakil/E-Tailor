        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <div class="logo-sm">
                    ...
                    <a class="logo-box" href="${pageContext.request.contextPath}/adminpanel"><span>ecaps</span></a>
                </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="javascript:void(0)" class="right-sidebar-toggle" data-sidebar-id="main-right-sidebar"></i> Hello  !   ${sessionScope.UserLoggedIn}</a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="resources/images/sweing.gif" alt="" class="img-circle"></a>
