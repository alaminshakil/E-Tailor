<%-- 
    Document   : main
    Created on : Jul 2, 2019, 7:32:28 AM
    Author     : alami
--%>
...
<html>
    ...
    <head>
        ...
        <!--//tags -->
        <link href="resources/public/css/darkbox.css" rel="stylesheet" type="text/css" media="all" />
        <link rel="resources/public/stylesheet" href="css/owl.carousel.css" type="text/css" media="all">
        <link href="resources/public/css/wimmViewer.css" rel="stylesheet" type="text/css">
        <link href="resources/public/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
        <link href="resources/public/css/style.css" rel="stylesheet" type="text/css" media="all" />
        ...
        <div class="header" id="home">
            <div class="banner_header_top_wthree">
                <div class="agileits-logo">
                    <h1><a href="index.jsp"> <i class="fa fa-scissors" aria-hidden="true"></i> ETailor</a></h1>
                </div>
                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu agile_short_dropdown">
                                                ...
                                                <li><a href="reportView">Reports</a></li>
                                            </ul>
                                        </li>
                                ...
                                <div class="w3_agile_phone">
                                    <p><i class="fa fa-phone" aria-hidden="true"></i> +8801515261234</p>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="agile_wthree_inner_grids">
                        ...
                        <div class="col-md-6 about_agileinfo_grid_imgs">
                            <img src="resources/public/images/ab.jpg" alt="" />
                            <div class="aboutimg">
                                <img src="resources/public/images/ab2.jpg" alt="" />
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="modal-info">
                                <h4>Stitchery</h4>
                                <img src="resources/public/images/banner2.jpg" alt=" " class="img-responsive" />
                ...
                <div class="container">
                    ...
                    <div class="w3_agile_team_grids">
                        <div class="col-md-3 w3_agile_team_grid">
                            <img src="resources/public/images/t2.jpg" alt=" " class="img-responsive" />
                            <h3>Amanda Seylon</h3>
                            <p>Designer</p>
                        ...
                        <div class="col-md-3 w3_agile_team_grid">
                            <img src="resources/public/images/t1.jpg" alt=" " class="img-responsive" />
                            <h3>Laura Mark</h3>
                            <p>Designer</p>
                            <ul class="footer_list_icons team_icons_agile">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="col-md-3 w3_agile_team_grid">
                            <img src="resources/public/images/t3.jpg" alt=" " class="img-responsive" />
                            <h3>Lusiana James</h3>
                            <p>Designer</p>
                            <ul class="footer_list_icons team_icons_agile">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="col-md-3 w3_agile_team_grid">
                            <img src="resources/public/images/t4.jpg" alt=" " class="img-responsive" />
                            <h3>John Mark</h3>
                            <p>Designer</p>
                            <ul class="footer_list_icons team_icons_agile">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="gallery" id="gallery">
                    ...
                    <div class="agile_port_w3ls_info">
                        <div class="col-md-6 agile_gallery_grid_left">
                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g1.jpg" data-darkbox="images/g1.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g2.jpg" data-darkbox="images/g2.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g3.jpg" data-darkbox="images/g3.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                        </div>
                        <div class="col-md-6 agile_gallery_grid_left">

                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g5.jpg" data-darkbox="images/g5.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g4.jpg" data-darkbox="images/g4.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                            <div class="col-md-6 agile_gallery_grid">
                                <img src="resources/public/images/g6.jpg" data-darkbox="images/g6.jpg" data-darkbox-description="<b>Add Short description</b><br>Lorem ipsum dolor sit amet">
                            </div>
                        </div>
                        <div class="clearfix"> </div>
                            ...
                            <div class="col-md-6 clients_agile_slider">
                                <div id="owl-demo" class="owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="agile_tesimonials_content">
                                            <div class="about-midd-main">
                                                <img class="agile-img" src="resources/public/images/c1.png" alt=" " class="img-responsive">
                                                <h4>Smith Kevin</h4>
                                    ...
                                    <div class="item">
                                        <div class="agile_tesimonials_content">
                                            <div class="about-midd-main">
                                                <img class="agile-img" src="resources/public/images/c2.png" alt=" " class="img-responsive">
                                                <h4>Laura Hill</h4>
                                                <p> Lorem ipsum adipiscing elit, sed do eiusmod idunt ut labore. sed do eiusmod tempor incididunt.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item">
                                        <div class="agile_tesimonials_content">
                                            <div class="about-midd-main">
                                                <img class="agile-img" src="resources/public/images/c3.png" alt=" " class="img-responsive">
                                                <h4>Thomson Doe</h4>
                                                <p> Lorem ipsum adipiscing elit, sed do eiusmod idunt ut labore. sed do eiusmod tempor incididunt.</p>
                                            </div>
                                        </div>
                        ...
                        <div class="footer-top_agile_w3l">
                            <div class="container">
                                ...
                                <div class="wthree_copy_right">
                                    <p>Copyright 201 Stitcher. All rights reserved | Design by <a href="http://facebook.com/md.alamin.shakil">Al Amin Shakil</a></p>
                                </div>
                            </div>
                        </div>
                ...
                <!-- js -->
                <script type="text/javascript" src="resources/public/js/jquery-2.1.4.min.js"></script>
                <!-- start-smoth-scrolling -->
                <script type="text/javascript" src="resources/public/js/move-top.js"></script>
                <script type="text/javascript" src="resources/public/js/jquery.easing.min.js"></script>
                ...
                <!-- //smooth-scrolling-of-move-up -->  
                <script type="text/javascript" src="resources/public/js/darkbox.js"></script>
                <script src="resources/public/js/wimmViewer.js"></script>
                <script>
    $(function () {
        $('#slider1').WimmViewer({
            miniatureWidth: 100,
            miniatureHeight: 100
                ...
                <script src="resources/public/js/jquery.magnific-popup.js" type="text/javascript"></script>
                <!-- //Pricing-Popup-Box-JavaScript -->
                <!-- carousel -->
                <script src="resources/public/js/owl.carousel.js"></script>
                <!-- //carousel -->
                <!-- for bootstrap working -->
                <script type="text/javascript" src="resources/public/js/customJquery.js"></script>
